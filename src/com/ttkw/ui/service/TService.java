...
import com.ttkw.ui.Utils.VisualizerUtils;
import com.ttkw.ui.asyntask.GetBitmapTask;
import com.ttkw.ui.cache.ImageInfo;
import com.ttkw.ui.config.Constants;
import com.ttkw.ui.preferences.SharedPreferencesCompat;
...
public class TService extends Service implements GetBitmapTask.OnBitmapReadyListener {
    ...
    public void onCreate() {
        ...
        //组件名称，第一个参数是包名，也是主配置文件Manifest里设置好的包名    第二个是类名
        ...
        mPreferences = getSharedPreferences(Constants.APOLLO_PREFERENCES, MODE_WORLD_READABLE
