...
public class AppWidget42 extends AppWidgetProvider {
    ...
    private void defaultAppWidget(Context context, int[] appWidgetIds) {
    	...
    	String widget_type = sp.getString(Constants.WIDGET_STYLE, context.getResources().getString(R.string.widget_style_light) );
    ...
    public void performUpdate(TService service, int[] appWidgetIds) {
    	...
    	String widget_type = sp.getString(Constants.WIDGET_STYLE, mContext.getResources().getString(R.string.widget_style_light) );
